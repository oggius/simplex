...
abstract class Smarty_CacheResource {
    ...
    */
    ...
    /**
    * Load CacheDriver Resource Handler
    *
    * @param Smarty $smarty Smarty object
    * @param string $type name of the cache resource
    * @return Smarty_CacheResource CacheDriver Resource Handler
    */
    ...
    /**
    * Invalid Loaded CacheDriver Files
    *
    * @param Smarty $smarty Smarty object
    */
...
*
* CacheDriver Data Container for Template Files
*
* @package Smarty
...
class Smarty_Template_Cached {
    ...
    */
    ...
    /**
    * CacheDriver Is Valid
    * @var boolean
    */
    public $valid = false;

    /**
    * CacheDriver was processed
    * @var boolean
    */
    ...
    */
    ...
    /**
    * Template CacheDriver Id (Smarty_Internal_Template::$cache_id)
    * @var string
    */
